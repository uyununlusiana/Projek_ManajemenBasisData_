...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
	...
	<hl class="h2">Form Data Pendaftaran</h1>
	</div>
...
<div class="table-responsive">
		<form action="simpan_ubah_pendaftaran.php" method="POST">
			<div class="col-6">
				<div class="mb-3">
					...
					<div class="mb-3">
					<label for="exampleFormControlTextarea1" class="form-label">Tmp Lahir</label>
					<input type="text" name="tmp_lahir" value="<?=$rs['tmp_lahir']; ?>" class="form-control">
				</div>
					<div class="mb-3">
					<label for="exampleFormControlTextarea1" class="form-label">Tgl Lahir</label>
					<input type="text" name="tgl_lahir" value="<?=$rs['tgl_lahir']; ?>" class="form-control">
				</div>
					<div class="mb-3">
					...
					<input type="text" name="nama_ibu" value="<?=$rs['nama_ibu']; ?>" class="form-control">
				</div>
					<div class="mb-3">
				...
				<input type="hidden" value="<?= $id; ?>" name="id_pendaftaran" id="">
